...
def takeInput():
    ...
    if final_Result[0] == 1:
        ...
        label2 = tkinter.Label(substituteWindow, text="❤️‍🩹 PLEASE VISIT NEAREST CARDIOLOGIST AT THE EARLIEST ❤️‍🩹", font=('Impact', -20), fg='red')
        label2.grid(row=1, column=1, columnspan=6)
        label3 = tkinter.Label(substituteWindow, text = "Dr. Abhishek Laxman Wadkar - Cardiologist", font=('Times', -15))
        label3.grid(row=3, column = 2)
        label4 = tkinter.Label(substituteWindow, text = "Nanavati Super-specialty Hospital", font=('Times', -15))
        label4.grid(row=4, column = 2)
        label4 = tkinter.Label(substituteWindow, text = "Dr. Ghanshyam Ramnath Kane - Cardiologist", font=('Times', -15))
        ...
        label2 = tkinter.Label(substituteWindow, text="Do not forget to exercise daily. 🏃🤸‍♂️🚴 ", font=('Impact', -20), fg='green')
...
sexFrame = tkinter.LabelFrame(mainWindow, text="Sex [0 (F)|1 (M)]")
